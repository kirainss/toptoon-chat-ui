    ...
    <div className="fixed inset-0 md:left-[260px] z-[55] flex flex-col overflow-hidden bg-[#121212]">
      ...
      <div className="flex items-center h-[52px] px-4 bg-[#121212] border-b border-white/5 flex-shrink-0">
        ...
        <div className="flex items-center gap-3 ml-auto">
          <div className="flex items-center gap-1.5">
            <div className="flex items-center gap-1.5 text-[#FACC15] px-3 py-1.5 rounded-full border border-[#EAB308]/40" style={{ background: 'linear-gradient(135deg, #3D2800, #5C3C00)', boxShadow: '0 0 12px rgba(234,179,8,0.3), inset 0 1px 0 rgba(255,255,255,0.08)' }}>
      ...
      <div className="flex md:hidden flex-col flex-1 overflow-hidden">
        ...
        <div className="relative z-30 flex items-center justify-between h-[55px] px-3 bg-[#121212] flex-shrink-0 border-b border-white/10">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1 text-[#FACC15] px-2.5 py-1 rounded-full border border-[#EAB308]/40" style={{ background: 'linear-gradient(135deg, #3D2800, #5C3C00)', boxShadow: '0 0 12px rgba(234,179,8,0.3), inset 0 1px 0 rgba(255,255,255,0.08)' }}>
